function searchAction(form) {
  var lege = document.getElementById('lege').value;
  console.log(lege);
  if (lege == "") {
    form.action = "/legi";
  }
  ...
  {
    form.action = "/legi_search/number=" + lege;
  }
}
...
function showUpdateModal(id, nr, desc) {
    ...
    var nrInput = form.querySelector("input[name='Nr.Lege']");
    var descInput = form.querySelector("input[name='Descriere']");

    if (nrInput && descInput) {
        nrInput.value = nr;
        descInput.value = desc;

        // Set the placeholder of the input fields
        nrInput.placeholder = "Nr.Lege";
